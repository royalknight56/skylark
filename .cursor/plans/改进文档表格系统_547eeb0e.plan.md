---
name: 改进文档表格系统
overview: 基于飞书文档表格功能，为当前 TipTap 表格增加浮动操作工具栏、单元格背景色、合并/拆分、标题行列切换、行列增删控制等交互能力。当前只有基础的表格插入和 CSS 样式，缺少所有表格编辑操作的 UI 入口。
todos:
  - id: table-menu
...
参考 [飞书文档表格](https://www.feishu.cn/hc/zh-CN/articles/639833584167)：
